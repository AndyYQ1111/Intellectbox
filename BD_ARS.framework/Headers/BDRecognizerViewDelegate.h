 ...
 *
 * @param aBDRecognizerViewController 弹窗UI
 * @param aResult 返回结果，原始Json结果
 */
 ...
 * @brief 发生错误
 *
 * @param errClass 错误类别 (TVoiceRecognitionClientErrorStatusClass)
 * @param errCode 错误码 (TVoiceRecognitionClientErrorStatus)
